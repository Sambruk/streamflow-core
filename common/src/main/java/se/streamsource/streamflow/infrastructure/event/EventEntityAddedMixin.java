 ...
 * void fooAdded(DomainEvent event, SomeType)
        ...
        implements InvocationHandler
{
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable
    {
        ...
        if (manyAssociationMethod == null)
        {
            ...
            String addedName = method.getName().substring(0, method.getName().length() - "Added".length()) + "s";
            ...
            implements AppliesToFilter
    {
        public boolean appliesTo(Method method, Class<?> mixin, Class<?> compositeType, Class<?> fragmentClass)
        {
            return method.getParameterTypes().length == 2 &&
                    method.getParameterTypes()[0].equals(DomainEvent.class) && method.getName().endsWith("Added") &&
