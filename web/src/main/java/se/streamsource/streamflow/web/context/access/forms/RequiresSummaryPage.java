...
@Constraints(RequiresSummaryPage.Constraint.class)
public @interface RequiresSummaryPage
{
   public abstract boolean value() default true;

   public class Constraint
         implements org.qi4j.api.constraint.Constraint<RequiresSummaryPage, SubmittedPageValue>
   {
      public boolean isValid( RequiresSummaryPage page, SubmittedPageValue value )
      {
