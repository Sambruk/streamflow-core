        ...
        extends AbstractLayerAssembler
{
   ...
   private void plugins(ModuleAssembly module) throws AssemblyException
   {
      new ClientAssembler().assemble(module);

      module.services(ContactLookupService.class).
              identifiedBy("contactlookup").
              visibleIn(Visibility.application).
              instantiateOnStartup();

      module.values(ContactList.class,
              ContactValue.class,
   ...
   private void caching(ModuleAssembly module) throws AssemblyException
   {
      module.services(CachingServiceComposite.class).visibleIn(Visibility.application);

      //     module.services( EhCachePoolService.class ).visibleIn( Visibility.layer );
   }
