...
import se.streamsource.streamflow.web.context.access.projects.TaskTypesContext;
...
public interface OrganizationsContext
   extends SubContexts<ProjectsContext>, IndexContext<LinksValue>, Context
{
      ...
      implements OrganizationsContext
   {
      ...
      public ProjectsContext context( String id )
      {
