 ...
 * JAVADOC
 */
public class FormSignaturesResource
   extends CommandQueryResource
   implements SubResources
{
   public FormSignaturesResource()
   {
      super( FormSignaturesContext.class );
   }

   public void resource( String segment ) throws ResourceException
   {
      findList( role( RequiredSignatures.Data.class ).requiredSignatures().get(), segment );
      subResourceContexts( FormSignatureContext.class );
   }
}
