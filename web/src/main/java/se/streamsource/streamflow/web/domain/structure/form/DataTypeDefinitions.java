...
public interface DataTypeDefinitions
{
         ...
         implements DataTypeDefinitions, Data
   {
      ...
      public void addedDataTypeDefinition( DomainEvent event, DataTypeDefinition fieldTypeDefinition )
      {
         data.dataTypeDefinitions().add( fieldTypeDefinition );
      }

      public void removedDataTypeDefinition( DomainEvent event, DataTypeDefinition fieldTypeDefinition )
      {
         data.dataTypeDefinitions().remove( fieldTypeDefinition );
      }
   }
}
