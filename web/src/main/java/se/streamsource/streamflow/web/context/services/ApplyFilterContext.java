      ...
      private void sendEmailToParticipant(UserEntity administrator, Participant participant)
      {
         if (participant instanceof Contactable)
         {
            ...
            if (email != null)
            {
               ...
               builder.prototype().subject().set("Nytt ärende:" + self.caseId().get()); // TODO These texts need to use the locale for the user
               builder.prototype().content().set("Du har ett nytt ärende att hantera. Se bifogad PDF");
