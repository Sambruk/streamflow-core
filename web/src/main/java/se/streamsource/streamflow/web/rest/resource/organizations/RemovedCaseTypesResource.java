...
import se.streamsource.streamflow.web.context.administration.RemovedCaseTypesContext;
 ...
 * JAVADOC
 */
public class RemovedCaseTypesResource
      extends CommandQueryResource
      implements SubResources
{
   public RemovedCaseTypesResource()
   {
      super( RemovedCaseTypesContext.class );
   }

   public void resource( String segment ) throws ResourceException
   {
      setResourceValidity( setRole(CaseTypeEntity.class, segment) );
