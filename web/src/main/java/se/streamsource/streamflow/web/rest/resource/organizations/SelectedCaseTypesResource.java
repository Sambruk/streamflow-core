 ...
 * JAVADOC
 */
public class SelectedCaseTypesResource
      extends CommandQueryResource
      implements SubResources
{
   public SelectedCaseTypesResource()
   {
      super( SelectedCaseTypesContext.class );
   }

   public void resource( String segment ) throws ResourceException
   {
      findManyAssociation( role( SelectedCaseTypes.Data.class ).selectedCaseTypes(), segment );
      subResourceContexts( SelectedCaseTypeContext.class );
   }
}
