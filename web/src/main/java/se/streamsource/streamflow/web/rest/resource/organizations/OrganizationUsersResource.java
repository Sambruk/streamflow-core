   ...
   implements SubResources
{
   ...
   {
      OrganizationParticipations.Data participations = setRole( OrganizationParticipations.Data.class, segment );
      if (!participations.organizations().contains( RoleMap.role( Organization.class )))
