...
@Mixins(ProjectOrganizationalUnitQueries.Mixin.class)
public interface ProjectOrganizationalUnitQueries
{
   OrganizationalUnit topOU();

   class Mixin
         implements ProjectOrganizationalUnitQueries
   {
      @This
      ...
      public OrganizationalUnit topOU()
      {
