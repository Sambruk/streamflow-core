...
import se.streamsource.streamflow.web.context.administration.forms.definition.FieldGroupContext;
...
{
   public FieldGroupResource()
   {
      super( FieldGroupContext.class, DescribableContext.class );
   }
