...
public class FilterContext
   implements DeleteContext, IndexContext<FilterValue>, UpdateContext<FilterValue>
{
   @Structure
   Module module;
   ...
   public FilterValue index()
   {
      return filter;
   }

   public void update(FilterValue value)
   {
      filters.updateFilter(idx, value);
   }
