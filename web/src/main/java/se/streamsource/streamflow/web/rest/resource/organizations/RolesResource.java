...
import se.streamsource.streamflow.web.context.administration.RolesContext;
      ...
      implements SubResources
{
   ...
   {
      super( RolesContext.class );
   }

   public void resource( String segment ) throws ResourceException
   {
      findManyAssociation( role( Roles.Data.class ).roles(), segment );
      subResourceContexts( RoleContext.class, DescribableContext.class );
   }
}
