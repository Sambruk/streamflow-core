 ...
 * JAVADOC
 */
public class SelectedFormsResource
      extends CommandQueryResource
      implements SubResources
{
   public SelectedFormsResource()
   {
      super( SelectedFormsContext.class );
   }

   public void resource( String segment ) throws ResourceException
   {
      findManyAssociation( RoleMap.role( SelectedForms.Data.class).selectedForms(), segment );
      subResourceContexts( SelectedFormContext.class );
   }
}