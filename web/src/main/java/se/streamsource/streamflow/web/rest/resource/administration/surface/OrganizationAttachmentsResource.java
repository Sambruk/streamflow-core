      ...
      implements SubResources
{
   ...
   public void createattachment() throws IOException, URISyntaxException
   {
      ...
      if (MediaType.MULTIPART_FORM_DATA.equals( representation.getMediaType(), true ))
      {
         ...
         try
         {
                  ...
                  && !found;)
            {
               ...
               {
                  found = true;
                  Attachment attachment = context(OrganizationAttachmentsContext.class).createAttachment(fi.getInputStream());
      ...
      } else
      {
         ...
         Attachment attachment = context(OrganizationAttachmentsContext.class).createAttachment(in);
