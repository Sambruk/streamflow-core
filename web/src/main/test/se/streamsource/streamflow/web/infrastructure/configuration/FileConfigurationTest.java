        ...
        extends AbstractQi4jTest
{
    ...
    public void testMac()
    {
        ...
        Assert.assertThat("configuration is correct", config.configurationDirectory(), CoreMatchers.equalTo(new File(user + "/Library/Preferences/streamflow")));
    }
    ...
    public void testLinux()
    {
        ...
        Assert.assertThat("configuration is correct", config.configurationDirectory(), CoreMatchers.equalTo(new File("/etc/opt/streamflow")));
    }
}
