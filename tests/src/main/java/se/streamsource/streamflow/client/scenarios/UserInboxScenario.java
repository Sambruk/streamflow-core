...
import se.streamsource.streamflow.client.model.shared.UserInboxSteps;
import se.streamsource.streamflow.client.test.AbstractClientApplicationScenario;

/**
 * JAVADOC
 */
public class UserInboxScenario
        extends AbstractClientApplicationScenario
{
    public UserInboxScenario()
    {
        this(Thread.currentThread().getContextClassLoader());
    }

    public UserInboxScenario(ClassLoader classLoader)
    {
        super(classLoader, new IndividualSteps(), new UserInboxSteps());
    }
}