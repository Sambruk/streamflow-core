        ...
        extends AbstractWebDomainApplicationScenario
{
    ...
    {
        super(classLoader, new GroupsSteps(), new GroupsSetupSteps(), new TaskSetupSteps(), new OrganizationalUnitsSetupSteps(), new OrganizationsSteps(), new UserSteps(), new UserSetupSteps());
    }
}