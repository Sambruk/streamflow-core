        ...
        extends Steps
{
    ...
    private UserEntity createUser(String userName, String password) throws Exception
    {
        UserEntity user = organizationsSteps.organizations.createUser(userName, password);
