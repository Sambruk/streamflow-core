...
import se.streamsource.streamflow.client.application.shared.steps.SharedInboxSteps;
import se.streamsource.streamflow.client.test.AbstractClientApplicationScenario;

/**
 * JAVADOC
 */
public class CompleteSharedTask
        extends AbstractClientApplicationScenario
{
    public CompleteSharedTask()
    {
        this(Thread.currentThread().getContextClassLoader());
    }

    public CompleteSharedTask(ClassLoader classLoader)
    {
        super(classLoader, new LoginSteps(), new SharedInboxSteps());
    }
}