...
(function () {
  'use strict';
	...
	var sfServices = angular.module('sf.services.profile', ['sf.services.backend', 'sf.services.navigation', 'sf.models', 'sf.services.forms']);

 	sfServices.factory('profileService', ['backendService', 'navigationService', 'SfCase', '$http', 'debounce', 'formMapperService', 
 		function (backendService, navigationService, SfCase, $http, debounce, formMapper) {
