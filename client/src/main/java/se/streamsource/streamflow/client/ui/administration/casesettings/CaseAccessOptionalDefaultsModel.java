 ...
 * JAVADOC
 */
public class CaseAccessOptionalDefaultsModel
      extends ResourceModel<CaseAccessOptionalDefaultsDTO>
{
   ...
   public void changeOptionSetting( Boolean setting )
   {
      Form form = new Form();
      form.set( "optional", setting.toString() );
      client.postCommand( "changeoptional", form );
   }
}
