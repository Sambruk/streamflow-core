...
public enum WorkspaceResources
{
    ...
    select_account,
    could_not_create_label, could_not_refresh_list_of_labels, submitted_forms_tab, effective_fields_tab, could_not_get_submitted_form, field_name, field_value, could_not_perform_operation, search_user
}