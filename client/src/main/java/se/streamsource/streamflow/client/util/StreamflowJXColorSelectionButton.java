 ...
 *
 * arvidhuss for streamflow
 * Minor changes due to we need to trigger on dialog button ok action event.
 */
public class StreamflowJXColorSelectionButton extends JButton
{
...
//    }
   ...
   private void showDialog() {
      ...
      if (dialog == null) {
         dialog = JColorChooser.createDialog(StreamflowJXColorSelectionButton.this,
               i18n.text( AdministrationResources.choose_color ), true, getChooser(),
               new ActionListener() {
         ...
         //      new ColorChangeListener(StreamflowJXColorSelectionButton.this));
      }
