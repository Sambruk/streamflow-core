...
public class AddCommentDialog
      extends JPanel
{
   private StateBinder commentBinder;
   ...
   )
   {
      ...
      commentBinder = new StateBinder();
      commentBinder.setResourceMap( appContext.getResourceMap( getClass() ) );
      NewCommentCommand template = commentBinder.bindingTemplate( NewCommentCommand.class );


      BindingFormBuilder bb = new BindingFormBuilder( builder, commentBinder );
      ...
      commentBinder.updateWith( commandBuilder.prototype() );
   }
