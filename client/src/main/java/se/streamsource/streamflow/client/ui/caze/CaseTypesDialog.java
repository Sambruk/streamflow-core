      ...
      extends JPanel
{
   ...
   public CaseTypesDialog( @Service ApplicationContext context )
   {
   ...
   public JList getCaseTypeSelector()
   {
      return list.getList();
   }

   public void setModel( PossibleCaseTypesModel model )
   {
      model.refresh();
      list.setEventList( model.getCaseTypeList() );
   }
