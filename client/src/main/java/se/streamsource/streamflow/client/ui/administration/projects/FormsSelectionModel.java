        ...
        extends AbstractListModel
{
    ...
    public FormsSelectionModel(@Uses OrganizationalUnitAdministrationModel organizationModel)
    {
        try
        {
            forms = organizationModel.getOrganization().formDefinitions().items().get();
