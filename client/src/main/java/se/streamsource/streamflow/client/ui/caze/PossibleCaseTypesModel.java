...
/**
 * List of possible case types for a case.
 */
public class PossibleCaseTypesModel
      implements Refreshable
{
   ...
   private BasicEventList<LinkValue> caseTypeList = new BasicEventList<LinkValue>();
   ...
   public void refresh() throws OperationException
   {
      try
      {
         LinksValue caseTypes = client.query( "possiblecasetypes", LinksValue.class );

         EventListSynch.synchronize( caseTypes.links().get(), caseTypeList );
