...
package se.streamsource.streamflow.client.resource.users.workspace.user.labels;
 ...
 * JAVADOC
 */
public class ProjectLabelsClientResource
    extends CommandQueryClientResource
    implements LabelsClientResource
{
    public ProjectLabelsClientResource(@Uses Context context, @Uses Reference reference)
    {
