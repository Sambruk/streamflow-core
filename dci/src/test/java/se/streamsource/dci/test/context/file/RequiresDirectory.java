...
public @interface RequiresDirectory
{
   class ConstraintImpl
      implements Constraint<RequiresDirectory, InteractionContext>
   {
      public boolean isValid( RequiresDirectory requiresRoles, InteractionContext context )
      {
         return !context.role( File.class ).isFile();
      }
   }
}