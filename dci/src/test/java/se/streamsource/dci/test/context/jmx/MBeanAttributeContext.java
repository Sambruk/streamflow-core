      ...
      implements IndexContext<Value>
{
   public Value index()
   {
      try
      {
         Object attribute = context.role( MBeanServer.class ).getAttribute( context.role( ObjectName.class ), context.role( MBeanAttributeInfo.class ).getName() );
   ...
   {
      Attribute attribute = new Attribute( context.role( MBeanAttributeInfo.class ).getName(), newValue.string().get() );
      context.role( MBeanServer.class ).setAttribute( context.role( ObjectName.class ), attribute );
   }
}